...
function key() {
  ...
  // A placeholder here produced "Incorrect API key provided: YOUR_OPE*******_KEY"
  // from OpenAI, as an unhandled throw with a stack trace, after the run had already
  // reported its token estimate and started a progress bar.
  requireKey('OPENAI_API_KEY', k);
  return k;
}
